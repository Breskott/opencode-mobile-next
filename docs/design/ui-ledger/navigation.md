...
graph LR
  ...
  embedded_chat_nudge_slot(["embedded-chat-nudge-slot"])
...
| `team-home-runs-tab` | tab | 2 / 4 | `team-home` / team-home-segments<br>`team-home` / team-home-segments-menu-item | team-home-runs-row -> `team-run`<br>team-home-runs-tab-empty-start-run -> `start-run-sheet` |
